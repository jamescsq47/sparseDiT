...
def ring_flash_attn_forward(
    ...
    for step in range(comm.world_size):
        ...
        if not causal or step <= comm.rank:
            ...
            print(f"rank {comm.rank} step {step} sparse density: {sparse_part.float().sum()},{sparse_part.dtype},{sparse_part.shape}")
            ...
            if attn_type == AttnType.SPARSE_SAGE or attn_type == AttnType.SPARGE:
                ...
                print(f"block_out shape: {block_out.shape}, block_lse shape: {block_lse.shape}, out shape: {None if out is None else out.shape}, lse shape: {None if lse is None else lse.shape}")
