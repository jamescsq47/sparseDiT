...
class LongContextAttention(torch.nn.Module):
    ...
    def forward(
        ...
        *args: Any,
        ...
        # scatter 1, gather 2
        output, work_o = SeqAllToAll4D.apply(
