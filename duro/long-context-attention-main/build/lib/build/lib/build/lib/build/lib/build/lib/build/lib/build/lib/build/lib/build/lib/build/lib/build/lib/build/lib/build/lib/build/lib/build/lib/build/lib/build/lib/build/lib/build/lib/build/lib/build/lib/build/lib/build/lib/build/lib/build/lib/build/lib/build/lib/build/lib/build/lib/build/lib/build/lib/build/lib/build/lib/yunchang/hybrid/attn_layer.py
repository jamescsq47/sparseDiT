...
class LongContextAttention(torch.nn.Module):
    ...
    def forward(
        ...
        *args: Any,
        ...
        print(f"context_layer:{context_layer.shape}, transpose_matrix_o:{None if transpose_matrix_o is None else transpose_matrix_o.shape}, new_row_deperm_idx:{None if new_row_deperm_idx is None else new_row_deperm_idx}")
